...
def load_model_with_weights(model_path, config_path, device):
    ...
    # 如果是 concat 模式，修改第一層和配置
    if combine_mode == 'concat':
        # 【新增】修改配置中的 num_channels
        ...
        # 【新增】同步更新 patch_embeddings 的 num_channels 屬性
        model.vit.embeddings.patch_embeddings.num_channels = 6
        
        print("已修改模型配置和第一層以支援 6 channels 輸入")
...
if __name__ == "__main__":
    ...
    # 選擇要評估的模型
    COMBINE_MODE = 'concat'  # 需與訓練時一致: 'concat', 'multiply', 'subtract'
