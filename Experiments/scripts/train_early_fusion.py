"""
Training script for Early Fusion Model (EEG Spectrogram + Images)
"""
...
def main(args):
    ...
    model = EarlyFusionModel(
        ...
        vit_d_model=config['model']['vit_d_model'],
        vit_num_layers=config['model']['vit_num_layers'],
        vit_num_heads=config['model']['vit_num_heads'],
        num_classes=config['model']['num_classes'],

        # EEG to image conversion
        eeg_n_fft=config['model']['eeg_n_fft'],
        eeg_hop_length=config['model']['eeg_hop_length'],
        eeg_n_mels=config['model']['eeg_n_mels'],
        eeg_num_channels=config['model']['eeg_num_channels'],
        ...
        freeze_pretrained=config['model']['freeze_pretrained']
    )

    model = model.to(device)

    logger.info(f"Model created with {model.get_num_params()} trainable parameters")
    logger.info(f"Fusion strategy: {config['model']['fusion_strategy']}")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '--config',
        type=str,
        default='Experiments/configs/early_fusion.yaml',
